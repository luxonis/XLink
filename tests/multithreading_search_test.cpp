...
int main(int argc, char** argv) {
    ...
    auto status = XLinkFindAllSuitableDevices(suitableDevice, deviceDescAllNonThreaded.data(), deviceDescAllNonThreaded.size(), &numdevNonThreaded, XLINK_DEVICE_DEFAULT_SEARCH_TIMEOUT_MS);
