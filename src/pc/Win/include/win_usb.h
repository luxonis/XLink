...
extern int usb_control_transfer(usb_hwnd han, uint8_t bmRequestType, uint8_t bRequest, uint16_t wValue, uint16_t wIndex, void *const buffer, size_t sz, uint32_t *wrote_bytes, int timeout_ms);
