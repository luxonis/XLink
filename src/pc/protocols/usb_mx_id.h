...
const uint8_t* usb_mx_id_get_wd_protection_start();
int usb_mx_id_get_wd_protection_start_size();
const uint8_t* usb_mx_id_get_wd_protection_end();
int usb_mx_id_get_wd_protection_end_size();
