                            ...
                            int size)
{
    ...
    // Add profiling data
    addLinkProfilingByStreamId(streamId, size, opTime, true);

    return X_LINK_SUCCESS;
}

XLinkError_t XLinkWriteData2(streamId_t const streamId, const uint8_t* buffer1, int buffer1Size, const uint8_t* buffer2, int buffer2Size)
{
    ...
    // Add profiling data
    addLinkProfilingByStreamId(streamId, totalSize, opTime, true);
...
XLinkError_t XLinkReadData(streamId_t const streamId, streamPacketDesc_t** packet)
{
    ...
    *packet = (streamPacketDesc_t *)event.data;
    ...
    // Add profiling data
    addLinkProfilingByStreamId(streamId, (*packet)->length, opTime, false);
