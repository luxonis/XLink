...
typedef enum {
    XLINK_PLATFORM_SUCCESS = 0,
    XLINK_PLATFORM_DEVICE_NOT_FOUND = -1,
    XLINK_PLATFORM_ERROR = -2,
    XLINK_PLATFORM_TIMEOUT = -3,
    XLINK_PLATFORM_INVALID_PARAMETERS = -4,
    XLINK_PLATFORM_INSUFFICIENT_PERMISSIONS = -5,
    XLINK_PLATFORM_DEVICE_BUSY = -6,
    XLINK_PLATFORM_DRIVER_NOT_LOADED = -128,
    XLINK_PLATFORM_USB_DRIVER_NOT_LOADED = XLINK_PLATFORM_DRIVER_NOT_LOADED+XLINK_USB_VSC,
    XLINK_PLATFORM_TCP_IP_DRIVER_NOT_LOADED = XLINK_PLATFORM_DRIVER_NOT_LOADED+XLINK_TCP_IP,
    XLINK_PLATFORM_PCIE_DRIVER_NOT_LOADED = XLINK_PLATFORM_DRIVER_NOT_LOADED+XLINK_PCIE,
