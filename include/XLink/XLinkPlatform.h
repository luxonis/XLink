...
typedef enum {
    ...
    X_LINK_PLATFORM_USB_DRIVER_NOT_LOADED = -4,
    X_LINK_PLATFORM_INVALID_PARAMETERS = -5,
    X_LINK_PLATFORM_INSUFFICIENT_PERMISSIONS = -6,
    X_LINK_PLATFORM_DEVICE_BUSY = -7,
    X_LINK_PLATFORM_TCP_IP_DRIVER_NOT_LOADED = -8,
    X_LINK_PLATFORM_PCIE_DRIVER_NOT_LOADED = -9,
